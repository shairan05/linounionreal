...
$meta_title = "Women's Linen Clothing Collection | LINO UNION";
$meta_description = 'Discover premium linen clothing for women. Dresses, tops, skirts, and jumpsuits crafted from the finest European flax. Free shipping over $150.';
require_once __DIR__ . '/includes/header.php';
$products = getProducts('women');
?>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <p class="text-muted mb-0">Effortless linen pieces designed for the modern woman. Fluid silhouettes, natural textures, timeless appeal.</p>
            </div>
...
<section class="py-4 border-bottom">
    <div class="container">
        <div class="d-flex flex-wrap gap-2 justify-content-center">
            <a href="women.php" class="btn btn-sm btn-dark">All Women</a>
            <?php
            $subs = getSubcategories('women');
            foreach ($subs as $sub): ?>
...
<section class="section-padding" id="products">
    <div class="container">
        ...
        <div class="empty-state">
            ...
            <p class="empty-state-text">Our women's collection is being curated. Sign up for updates.</p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product-card" data-aos="fade-up">
                    ...
                    <div class="product-card-info">
                        <div class="product-card-category"><?php echo htmlspecialchars($product['category_name'] ?? 'Women'); ?></div>
