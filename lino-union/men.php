...
$meta_title = "Men's Linen Clothing Collection | LINO UNION";
$meta_description = 'Discover premium linen clothing for men. Shirts, pants, shorts, and blazers crafted from the finest European flax. Free shipping over $150.';
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <p class="text-muted mb-0">Refined linen essentials for the modern man. Breathable, relaxed, and effortlessly sophisticated.</p>
            </div>
...
<section class="py-4 border-bottom">
    <div class="container">
        <div class="d-flex flex-wrap gap-2 justify-content-center">
            <a href="men.php" class="btn btn-sm btn-dark">All Men</a>
            <?php
            $subs = getSubcategories('men');
            foreach ($subs as $sub): ?>
...
<section class="section-padding" id="products">
    <div class="container">
        ...
        <div class="empty-state">
            ...
            <p class="empty-state-text">Our men's collection is being curated. Sign up for updates.</p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product-card" data-aos="fade-up">
                    ...
                    <div class="product-card-info">
                        <div class="product-card-category"><?php echo htmlspecialchars($product['category_name'] ?? 'Men'); ?></div>
